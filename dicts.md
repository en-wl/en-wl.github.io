...
ESDB is the basis for the official English dictionary in Aspell and
...
The default dictionaries correspond to ESDB size 60 and, to encourage
consistent spelling, generally only include one spelling variant for a word.
The large dictionaries correspond to ESDB size 70 and include common
...
dictionaries are also considerably larger than the ones based on ESDB, and
...
create your own from the information in ESDB using this [simple
...
a word will be accepted you can use the [ESDB Word Evaluation
...
The old app that checked if a word is in ESDB is retired.  If you want to
...
ESDB is in no way perfect, if you find words that don't belong or other
